...
public class PythonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Liên kết UI
        questionText = findViewById(R.id.question_Python);
        optionA = findViewById(R.id.answerA_Python);
        optionB = findViewById(R.id.answerB_Python);
        optionC = findViewById(R.id.answerC_Python);
        optionD = findViewById(R.id.answerD_Python);
        ...
        findViewById(R.id.next_Python).setOnClickListener(v -> {
    ...
    private ArrayList<Question> loadCauHoiJSON() {
        ...
        try {
            InputStream is = getResources().openRawResource(R.raw.questions_python);
