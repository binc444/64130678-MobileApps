...
public class JavaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Liên kết UI
        questionText = findViewById(R.id.question_Java);
        optionA = findViewById(R.id.answerA_Java);
        optionB = findViewById(R.id.answerB_Java);
        optionC = findViewById(R.id.answerC_Java);
        optionD = findViewById(R.id.answerD_Java);
        ...
        findViewById(R.id.next_Java).setOnClickListener(v -> {
    ...
    private ArrayList<Question> loadCauHoiJSON() {
        ...
        try {
            InputStream is = getResources().openRawResource(R.raw.questions_java);
